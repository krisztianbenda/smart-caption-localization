# USAGE
# python src/video_manager/detector_runner.py -i ~/repos/python/src/github.ibm.com/krisztian-benda/smart-caption-localization/test_images/4cars.png -o ~/repos/python/src/github.ibm.com/krisztian-benda/smart-caption-localization/src/video_manager/try --detectors ct -sh 130 -w 1000
...
def main():
    ...
    runner(args['image'], args['output_folder'], args['detectors'], args['subtitle_width'], args['subtitle_height'])

# runner returns with the best coordinates based on the detectors
def runner(image_path, output_folder, detectors, subtitle_width, subtitle_height) -> (int, int):
